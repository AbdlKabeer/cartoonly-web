              ...
              <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                <div className="mx-auto max-w-242.5">
                  <div className="overflow-hidden rounded-sm  bg-white ">
                    ...
                    <div className="relative z-20 h-full w-full bg-cover" style={{ backgroundImage: `url(${backgroundImageUrl})`}}>
                      ...
                      <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
                        <label htmlFor="cover"
                          ...
                          <span>
                            <svg className="fill-current" width="14" height="14" viewBox="0 0 14 14" fill="none"
                    ...
                    <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-8">
                      <div style={{ backgroundImage: `url(${backgroundImageUrl})`}}

                          className="relative z-30 mx-auto -mt-22 h-full min-h-[100px] max-h-[150px] bg-cover -translate-y-[50%] 
                              w-full min-w-[100px] max-w-[150px] rounded p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
