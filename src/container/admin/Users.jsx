    ...
    return (
        <>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7">
                <BreakDownCard Icon={LuUsers2}  cardText="Total Users" cardCount="3.456K"  cardPercent="0.43"/>
                <BreakDownCard Icon={LuUsers2}  cardText="Active Users" cardCount="3.456K"  cardPercent="0.43"/>
                {/* <BreakDownCard Icon={BsEye}  cardText="Pending Purchase" cardCount="$3.456K"  cardPercent="0.43"/> */}
            </div>
