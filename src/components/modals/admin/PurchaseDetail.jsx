...
export default function PurchaseDetail({setShowModal}) {
                            ...
                            <form action="#">
                                <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div className="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                        <input id="bordered-radio-1" onChange={()=> console.log('change')} type="radio" value="" name="bordered-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label htmlFor="bordered-radio-1" className="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Portrait with frame</label>
                                    </div>
                                    <div className="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                        <input checked id="bordered-radio-2" onChange={()=> console.log('change')}  type="radio" value="" name="bordered-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                        <label htmlFor="bordered-radio-2" className="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Portrait with frame</label>
                                    </div>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <motion.button whileTap={{ scale: 0.75 }}  type="button" className="cancel-button">
                                        Cancel
                                    </motion.button>

                                    <motion.button whileTap={{ scale: 0.75 }}  type="submit" className="dark-button ">
                                        Next
                                    </motion.button>
                                </div>
                            </form>
