                        ...
                        <form action="#">
                            <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                                <div className="relative w-full">
                                    <label htmlFor="email" className="hidden mb-2 font-medium  ">Email address</label>
                                    ...
                                    <input onChange={()=> console.log('change')}  className="block p-3 pl-10 w-full text-darkgray rounded-lg focus:ring-0 hover:outline-none border-gray-300 sm:rounded-none sm:rounded-l-lg   " placeholder="Enter your email" type="email" id="email" required="" />
                                </div>
                                <div>
