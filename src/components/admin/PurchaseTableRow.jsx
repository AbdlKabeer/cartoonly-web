...
export default function PurchaseTableRow({setActiveItem}) {
        ...
        <>
            <tr>
                <td className="border-b border-[#eee] py-5 px-4  xl:pl-11">
                    <a href="/users/1">
                        <h5 className="font-medium text-black hover:text-blue-500">Olanrewaju AbdulKabeer</h5>
                    </a>
                </td>
                <td className="border-b border-[#eee] py-5 px-4 ">
                    <p className="text-sm">09082455489</p>
                </td>
                <td className="border-b border-[#eee] py-5 px-4 ">
