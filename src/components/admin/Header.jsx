...
import logo from '../../assets/game.jpeg'
import logoText1 from '../../assets/carve2-crop.png'
import { AiOutlineClose } from "react-icons/ai";

export default function Header({showAdminSideBarMobile , setShowAdminSideBarMobile}) {
    ...
    return (
        <>
            <header className="sticky top-0 z-20 flex w-full drop-shadow-1 border-b shadow-sm bg-white">
                <div className="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
                    <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
                    <button onClick={()=> setShowAdminSideBarMobile(!showAdminSideBarMobile)} type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm  rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 " >
                    ...
                    <form action="https://formbold.com/s/unique_form_id" method="POST">
                        ...
                        <input type="text" placeholder="Type to search..."
                            className=" custom-input w-full bg-transparent pr-4 pl-9 focus:outline-none" />
                        </div>
                    </form>
                    </div> */}
                    ...
                    <ul className="flex items-center gap-2 2xsm:gap-4">
                        ...
                        <a className="relative flex h-8 w-8 bg-gray-400 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
                            href="#" >
                            ...
                            <svg className="fill-current duration-300 ease-in-out " width="18" height="18" viewBox="0 0 18 18" fill="none"
                    ...
                    <div className="relative" x-data="{ dropdownOpen: false }" >
                        <a onClick={() => setShowProfileDropDown(!showProfileDropDown)}  className="flex items-center gap-4" href="#" >
                        {/* <span className="hidden text-right lg:block">
                            <span className="block text-sm font-medium text-black dark:text-white">Olanrewaju AbdulKabeer</span>
                            <span className="block text-xs font-medium">olakay@gmail.com</span>
                        </span> */}

                        <motion.span whileTap={{ scale: 0.75 }}  className="h-8 w-8 rounded-full">
                            <img src='https://avatars.githubusercontent.com/u/95700260?s=48&v=4' alt="User" />
                        </motion.span>
                        ...
                        {showProfileDropDown && (
                            <div  className=" z-50 absolute -left-32   bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                                <div className="px-4 py-3 text-sm text-gray-900 ">
                                    <div>Olanrewaju Abdul</div>
                                    <div className="font-medium truncate">olakaycoder1@gmail.com</div>
                                </div>
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownUserAvatarButton">
                                    <li>
                                        <a href="/account/profile" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profile</a>
                                    </li>
                                    <li>
                                        <a href="/account/settings" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Settings</a>
                                    </li>
                                </ul>
                                <div className="py-2">
